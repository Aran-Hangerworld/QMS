...
<div class="container">
  ...
  <div class="col-md-12 col-sm-6">
      ...
      <div class="col-md-2 col-sm-4 col-centered"><a href="?m"><span class="glyphicon glyphicon-cog adminicons"></span><br />
        <h5>Dashboard</h5></a>
      </div>    
      <div class="col-md-2 col-sm-4 col-centered"><a href="?m=docs"><span class="glyphicon glyphicon-file adminicons"></span><br />
        <h5>Manage Documents</h5></a>
      </div>
      <div class="col-md-2 col-sm-4 col-centered"><a href="?m=users"><span class="glyphicon glyphicon-user adminicons"></span><br />
        <h5>Manage Users</h5></a>
      </div>
      <div class="col-md-2 col-sm-4 col-centered"><a href="?m=pages"><span class="glyphicon glyphicon-th-list adminicons"></span><br />
        <h5>Manage Page Content</h5></a>
      </div>
      <div class="col-md-2 col-sm-4 col-centered"><a href="?m=menus"><span class="glyphicon glyphicon-list-alt adminicons"></span><br />
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Active Docs</p>
                  </div>
                </div>
              </div>
...
$('#docnum').animateNumber(
  ...
  3000
	...
	$sth1 = $db->prepare('select * from QMS_users where QMS_inactive = inactive');
	$sth1->execute();  
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Active Cats</p>
                  </div>
                </div>
              </div>
            </div>
